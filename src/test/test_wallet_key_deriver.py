...
class TestWalletKeyDeriver(unittest.TestCase):
    ...
    def test_derive_eth_address(self):
        ...
        self.assertEqual(
            eth["private_key"], "1ab42cc412b618bdea3a599e3c9bae199ebf030895b039e9db1e30dafb12b727"
        )
        self.assertEqual(
            eth["public_key"], "0237b0bb7a8288d38ed49a524b5dc98cff3eb5ca824c9f9dc0dfdb3d9cd600f299"
        )
    ...
    def test_derive_btc_address(self):
        ...
        self.assertEqual(
            bit["private_key"], "e284129cc0922579a535bbf4d1a3b25773090d28c909bc0fed73b5e0222cc372"
        )
        self.assertEqual(
            bit["public_key"], "03aaeb52dd7494c361049de67cc680e83ebcbbbdbeb13637d92cd845f70308af5e"
        )
